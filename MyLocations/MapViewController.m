...
//  MyLocations
//
//  Created by Ryan Robinson on 5/25/14.
...
- (MapViewController *)initWithCoder:(NSCoder *)aDecoder
{
...
- (MKCoordinateRegion)regionForAnnotations:(NSArray *)annotations
{
    ...
    if ([annotations count] == 0) {
        ...
        const double extra_space = 1.1;
        
        region.center.latitude = topLeftCoord.latitude - (topLeftCoord.latitude - bottomRightCoord.latitude)/2.0;
        region.center.longitude = topLeftCoord.longitude - (topLeftCoord.longitude - bottomRightCoord.longitude)/2.0;
        
        region.span.latitudeDelta = fabs(topLeftCoord.latitude - bottomRightCoord.latitude) * extra_space;
        region.span.longitudeDelta = fabs(topLeftCoord.longitude - bottomRightCoord.longitude) * extra_space;
    }
